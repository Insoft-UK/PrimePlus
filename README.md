...
>[!WARNING]
PPL+ 26 (v5.0) will transition to using ICU. As a result, prebuilt Windows 11 binaries will no longer be provided. Users running Windows 11 who wish to use PPL+ v5.x will need to install ICU for Windows and compile the command line tool from source.
